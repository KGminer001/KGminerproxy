...
<p align="center">
  ...
  <a>
    <img src="https://img.shields.io/badge/软件版本-1.0.6-orgin.svg" alt="travis">
  </a>
    <a>
...
- 1.UI界面大幅优化，分析页UI增加本地加密协议展示。
- 2.视觉优化，全页面响应式；弹窗统一渐变标题栏，移动端底部按钮水平排列，修复协议按钮异常。
- 3.问题修复‌：修复备份还原损坏、本地加密数据拉取等核心问题；
- 4.优化币种/控制台页加载、CryptoCard性能等体验；增加微比特矿池BTC矿机无效优化。
